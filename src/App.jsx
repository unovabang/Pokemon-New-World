...
import YouTubeAudio from "./components/YouTubeAudio"; // + audio
    ...
    <nav className="nav">
      <div className="container nav-inner">
        ...
        >
          ...
          <a className="navlink" href="#download">
...
export default function App() {
  ...
  return (
    ...
    >
      ...
      {/* Lecteur audio discret (auto si possible) */}
      ...
      <div className="container">
        ...
        <section className="section" style={{ padding: 0 }}>
          <HeroVideo videoId={heroVideo.youtubeId}>
            <div>
              ...
              <p>Fangame Pokémon • Région de Bélamie</p>
              <div className="cta">
                <a className="btn btn-primary" href="#download">
                  <i className="fa-solid fa-cloud-arrow-down"></i> Télécharger
                </a>
        ...
        <section id="download" className="section card dl-section">
            ...
            <div className="tile">
              ...
              <div className="actions">
                ...
                {downloads.patchVideo && (
                  ...
                  >
                    <i className="fa-solid fa-circle-play"></i> Vidéo tutoriel
                  </button>
                )}
              </div>
            </div>
          ...
          <div className="callout" style={{ marginTop: 16 }}>
            <h4>
              <i className="fa-solid fa-circle-info"></i> Installer un patch
            </h4>
            <ul>
              <li>
                <i className="fa-solid fa-triangle-exclamation"></i>
                <span>
                  <strong>Prérequis :</strong> être déjà sur la version juste
                  avant le patch.
                </span>
              </li>
              <li>
                ...
                <span>
                  Téléchargez <code>Patch.zip</code> de la version cible.
                </span>
              </li>
              <li>
                <i className="fa-solid fa-folder-tree"></i>
                <span>
                  Placez <code>Patch.zip</code> à la <strong>racine</strong> du
                  dossier du jeu.
                </span>
              </li>
              <li>
                ...
                <span>
                  Extrayez <code>Patch.zip</code> (écrasez les fichiers si
                  demandé).
                </span>
              </li>
            </ul>
          ...
          <div className="meta-grid">
            <div className="card dl-card">
              <h3 className="dl-title">
                <i className="fa-solid fa-microchip"></i> Configuration requise
              </h3>
              <ul className="list-check" style={{ marginTop: 8 }}>
                <li>
